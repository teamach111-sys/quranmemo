<x-layouts::app.sidebar :title="$title ?? null">
    <div class="h-20 bg-[#FAFAFA] dark:text-white dark:bg-[#171717] dark:border-[#3E3E3E] w-full p-5 hidden border-b border-[#DEDEDE] lg:block">
        <select name="" id="" class="p-2 border focus:outline-none border-[#DEDEDE] h-10 rounded-md w-40">
