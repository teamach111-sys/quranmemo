...
<body class="min-h-screen bg-white dark:bg-darkcontentbg">
    <flux:sidebar sticky collapsible="mobile"
        class="border-e border-zinc-200 bg-zinc-50 dark:border-darkborder dark:bg-darksidebar">
        <flux:sidebar.header>
    ...
    <flux:header class="lg:hidden">
        ...
        <div class="h-20 flex items-center w-full p-5 dark:text-white dark:bg-darkcontentbg">
            <livewire:anneeselecteur />
        </div>
